...
public class IspitniRok {
	...
	public String toString() {
		String ispis = "Ispitni rok sa id " + id + " \u010Diji je naziv " + naziv + " odr\u017Eava se " + pocetak
				+ " do " + kraj;
		return ispis;
	}

	public String toStringAllIspitnaPrijava() {
		StringBuilder sb = new StringBuilder("Ispitni rok sa id " + id + "\u010Diji je naziv " + naziv
				+ " odr\u017Eava se " + pocetak + " do " + kraj);
