...
public class Student {
	...
	public String toString() {
		String ispis = "Student sa id " + id + " \u010Dije je ime i prezime " + ime + " " + prezime + " ima indeks "
				+ indeks + " i zivi u gradu " + grad;
		return ispis;
	}

	public String toStringAllPredmet() {
		StringBuilder sb = new StringBuilder("Student sa id " + id + " \u010Dije je ime i prezime " + ime + " "
				+ prezime + " ima indeks " + indeks + " i zivi u gradu " + grad);
